...
#   * Remove `managed = False` lines if you wish to allow Django # Feel free to rename the models, but don't rename db_table values or field names.to create, modify, and delete the table
